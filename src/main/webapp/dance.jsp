				...
				<section>
					...
					<div class="row gtr-100">
						<div class="col-10 col-10-medium">
							...
							<h2>댄스동아리 'CRAZY DANCE'에서 신입회원을 모집합니다.(~08/31)</h2>
							<hr />
							<p>
								댄스 동아리 CRAZY DANCE의 신입 크루들을 모집하고 있습니다.<br>
								<br>
								 기존 멤버분들은 여성 10분, 남성 5분들로 이루어져 있고 주로 아이돌 댄스와 힙합 댄스를 추고 있습니다.<br>
								 <br>
								  대학교는 광주권 위주로 선발하고 있으며, 안무 연습도 주로 광주 문화센터 안에서 이루어질 예정입니다.<br>
								  <br>
								  연락주시면 오디션 날짜와 장소 알려드리도록 하겠습니다.
							</p>
							<hr />
