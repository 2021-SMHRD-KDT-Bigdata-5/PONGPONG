...
<body class="is-preload">
	...
	<div id="wrapper">
				...
				<section>
					...
					<div class="row gtr-100">
						<div class="col-10 col-10-medium">
							...
							<!-- Text stuff -->
							<h2>CC의 회원이 되신 것을 환영합니다!</h2>
							
							<hr />

							<h3>CC에서 다양한 소식과 혜택을 누려보세요!</h3>
							<hr />
							<tr>
								<td><a href="index1.jsp">메인 페이지로 가기</td>
								<br><br>
								<td><a href="campus.jsp">동아리 게시판으로 가기</td>
								<br><br>
								<td><a href="study.jsp">스터디 게시판으로 가기</td>
								<br><br>
								<td><a href="buddy.jsp">친구 찾기 게시판으로 가기</td>
								<br><br>
							</tr>
		...
		<ul class="actions">
						<li><a href="mypage.jsp" class="button primary">마이 페이지</a></li>
						<li><a href="index1.jsp" class="button">로그아웃</a></li>
					</ul>
>
