	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<br>
				<h3>STUDY BOARD</h3><!-- 
<h2>금융권 스터디 인원 2명 충원합니다.(조대후문)</h2>
						<hr />
						<p>
							조대후문에서 금융권 NCS, 경제/경영상식, 면접 스터디를 함께할 인원 2명 충원합니다.<br> 기존 멤버
							3분은 모두 졸업생으로 이루어져 있구요. 졸업생들로 2명 희망합니다.<br> 대학교는 어느 곳이든
							상관없구요. 위치만 조대 후문이라는 거 알아주셨으면 해요!<br> 선착순으로 받겠습니다. 채팅 주세요 :)
						</p> -->
